    ...
    <div>
      <div className="my-10">
        <div className="relative">
          <section
            className=" bg-green-200 w-full h-[40vh] lg:h-[55vh] bg-cover bg-center brightness-50"
          ...
          <div className="absolute top-1/2 left-[5%] md:left-[10%] -translate-y-1/2 text-white">
            ...
            <p className="text-sm md:text-lg">Send messsage what you can.</p>
          </div>
        </div>

        <div className="w-full h-[1200px] md:h-[60vh] lg:h-[130vh] bg-blue-100 relative">
          <div className="absolute -top-[3%] md:-top-[10%] left-1/2 -translate-x-1/2 grid grid-cols-1 md:grid-cols-3 h-fit w-4/5 md:w-[90%] lg:w-4/5 rounded shadow overflow-hidden text-white">
            ...
            <div className="py-6 px-4 h-[500px] md:h-full bg-blue-400 grid grid-cols-1 grid-rows-5">
              ...
              <div className="row-span-4 flex flex-col items-center justify-center">
                ...
                <span>Abuzerk41@gmail.com</span>
              </div>

              <div className="flex justify-center md:justify-start items-center gap-4">
                <a title="youtube" href="#">
                  <img className="h-8 w-8 invert" src="https://www.svgrepo.com/show/521936/youtube.svg" />
                </a>
                <a title="linkedin" href="#">
                  <img className="h-12 w-12 invert" src="https://www.svgrepo.com/show/520815/linkedin.svg" />
                </a>
                <a title="instagram" href="#">
                  <img className="h-8 w-8 invert" src="https://www.svgrepo.com/show/521711/instagram.svg" />
                </a>
                <a title="github" href="#">
                  <img className="h-8 w-8 invert" src="https://www.svgrepo.com/show/512317/github-142.svg" />
                </a>
              </div>
              <h1 className="text-center">
                Follow me on github <a href="https://github.com/imabuzerkhan" target='_blank'>Imabuzerkhan</a>
              </h1>
            </div>
          </div>
        </div>
